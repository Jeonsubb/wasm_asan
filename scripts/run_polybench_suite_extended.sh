...
RUNS=${3:-100}
OUT_RAW=${4:-$REPORTS_DIR/polybench_overhead_extended_raw.tsv}
OUT_SUMMARY=${5:-$REPORTS_DIR/polybench_overhead_extended_summary.tsv}
...
benches=(
  ...
  "jacobi-2d stencils/jacobi-2d/jacobi-2d"
  "fdtd-2d stencils/fdtd-2d/fdtd-2d"
...
tmpdir=$(mktemp -d /tmp/polybench-suite-ext.XXXXXX)
