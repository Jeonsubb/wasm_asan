...
RUNS=${3:-30}
OUT_RAW=${4:-$REPORTS_DIR/polybench_overhead_remaining2_raw.tsv}
OUT_SUMMARY=${5:-$REPORTS_DIR/polybench_overhead_remaining2_summary.tsv}
...
tmpdir=$(mktemp -d /tmp/polybench-suite-rem2.XXXXXX)
